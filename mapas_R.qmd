...
Após carregar os arquivos em sua pasta do diretório de trabalho, você também deve baixar os arquivos com dados das regiões do Brasil. Para isso, faça as seguintes seleções:
