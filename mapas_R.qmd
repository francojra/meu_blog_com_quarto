...
![Pacote sf. Ilustração Alisson Horst.](images/Design%20sem%20nome.png){fig-align="center"}
...
Com nosso mapa pronto, podemos salvá-lo em formatos PDF ou PNG na pasta do diretório utilizando o seguinte código com valores de resolução (`dpi`), altura (`height`), largura (`width`) e unidade de medida (`units`) definidos:
