...
![](images/monsteRs.jpg){fig-align="center" width="400"}
...
![](images/img7.png){fig-align="center" width="400"}
...
2.  Durante o processo de atualização, você pode ser solicitado a confirmar algumas opções de configuração ou conceder permissões administrativas. Siga as instruções e aguarde até que a atualização seja concluída com sucesso.

3.  Você verá uma nova janela semelhante a esta abaixo, então basta clicar em concluir.

![](images/img6.png){width="500"}
