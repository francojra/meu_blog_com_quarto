...
Pesquise o RGui (R nativo) no menu Iniciar do Windows e execute os seguintes comandos. O pacote **`installr`** serve para executar a função **`updateR()`** que fará a atualização da versão:
