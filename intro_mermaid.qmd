...
O diagrama acima feito com ***Mermaid*** é um exemplo de ***flowchart*** utilizando o seguinte código:
...
O Mermaid soluciona esse problema por ajudar o usuário a criar e modificar diagramas de forma fácil, fazendo parte da produção de scripts que unem texto e códigos.
