...
Para ter acesso a esses dados traduzidos você pode utilizar a seguinte função para instalar o pacote `dados`, em seguida, você deve carregar o pacote utilizando a função `library` do R. Veja abaixo:
