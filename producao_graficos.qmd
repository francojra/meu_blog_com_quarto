...
ggplot(pinguins, aes(x = ilha, y = comprimento_nadadeira)) +
...
-   [Geom_col]{.underline}: função usada para definição do tipo de gráfico;

-   [Geom_errobar]{.underline}: função usada para inserir as barras de desvio padrão;

-   [Geom_boxplot]{.underline}:

-   [Geom_jitter]{.underline}:
